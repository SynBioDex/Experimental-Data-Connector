...
media_option = tk.OptionMenu(
    root, media, *media_options
)  # ENTER a command to reduce the selection process
...
media_button = Button(
    root, text="add", bg="#85e472", fg="black", command=media_dropdown
)
media_button.grid(column=2, row=3, sticky=tk.N + tk.S + tk.W + tk.E)

media_delete = Button(
    root, text="delete", bg="#e47272", fg="black", command=delete_mediaitems
)
...
strain_button = Button(
    root, text="add", bg="#85e472", fg="black", command=strain_dropdown
)
strain_button.grid(column=5, row=3, sticky=tk.N + tk.S + tk.W + tk.E)

strain_delete = Button(
    root, text="delete", bg="#e47272", fg="black", command=delete_strainitems
)
...
vector_option = tk.OptionMenu(
    root, vector, *vector_options
)  # ENTER a command to reduce the selection process
...
vector_button = Button(
    root, text="add", bg="#85e472", fg="black", command=vector_dropdown
)
vector_button.grid(column=2, row=7, sticky=tk.N + tk.S + tk.W + tk.E)

vector_delete = Button(
    root, text="delete", bg="#e47272", fg="black", command=delete_vectoritems
)
...
supp_delete = Button(
    root, text="delete", bg="#e47272", fg="black", command=delete_suppitems
)
...
excel_button = Button(
    ...
    fg="black",
    borderwidth=1,
    command=lambda: excel_sheet(gui_output),
)
